        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <a href="{{route('about-coin-trash')}}" class="btn btn-warning btn-sm" style="float:right"><i class="fa fa-trash"></i> Trash</a>
                    <a href="{{route('about-coin-create')}}" class="btn btn-primary btn-sm" style="float:right"><i class="fa fa-plus"></i>Add About Coins</a>
                    <br>
                    <table class="table border  user_datatable mt-3">
                        ...
                        <tbody>
                            @foreach ($aboutsCoins as $key => $coins)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$coins->title}}</td>
                                    ...
                                    <td>
                                        <a href="{{url('admin/about/coin/edit/'.base64_encode($coins->id))}}">
    ...
    <script>
        ...
        $(document).on('click', '.status', function (event) {
         ...
         if(confirm("Are you sure want to change the status ?")){
            $.ajax({
                  type:'POST',
                  url: "{{url('admin/about-coin-status')}}",
