...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
       <div class="col-md-11">
          <form action="{{route('cms-create')}}"  method="POST" id="cmscreate" enctype="multipart/form-data">
             @csrf
             <div class="form-body">
                <div class="card radius shadow-sm">
                   <div class="card-body">
                      <div class="row">
                         <div class="col-md-12">
                            <h4 class="card-title mb-1 mt-3">Create a New CMS </h4>
                            <p class="pb-border"> </p>
                         </div>
                      </div>
                      <div class="row">
...
<script>
    CKEDITOR.replace('description', {
     ...
     <script>
        ...
        $(document).on('click','.add_chose',function(){ 
            ...
            else
            {
                ...
                `<div class='chooseinput' row-id='1'>
                    ...
                    <p style='margin-bottom: 2px;' class='text-danger error_container error-title_points' id="error-title_points"></p>
                    </div>
                    <div class="col-md-5">
                    ...
                    <p style='margin-bottom: 2px;' class='text-danger error_container error-title_description' id="error-title_description"></p>
                    </div>
                ...
                var i=0;
                $('.error-title_points').each(function(){
                    $(this).attr('id','error-title_points_'+i);
                    i++;
                });
        ...
        $(document).on('submit', 'form#cmscreate', function (event) {
