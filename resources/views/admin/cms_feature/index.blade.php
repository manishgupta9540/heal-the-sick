        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <a href="{{route('cms-trash')}}" class="btn btn-warning btn-sm" style="float:right"><i class="fa fa-trash"></i> Trash</a>
                    <a href="{{route('cms-create')}}" class="btn btn-primary btn-sm" style="float:right"><i class="fa fa-plus"></i>Add Cms feature</a>
                    <br>
                    <table class="table border  user_datatable mt-3">
                        ...
                        <tbody>
                            @foreach ($cms_manages as $key => $coins)
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{$coins->title}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{url('admin/cms/edit/'.base64_encode($coins->id))}}">
