        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <a href="{{route('healthmanage-list')}}" class="btn btn-primary btn-sm" style="float:right">Previous</a>
                    <br>
                ...
                function(e) {
                    if (e == true) {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "{{ route('healthmanage-hard-delete') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                'id': id,
                                'table_name': table
                ...
                function(e) {
                    if (e == true) {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: "json",
                            url: "{{ route('healthmanage-restore-data') }}",
                            data: {
                                "_token": "{{ csrf_token() }}",
                                'id': id,
                                'table_name': table
