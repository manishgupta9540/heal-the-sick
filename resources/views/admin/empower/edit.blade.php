...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
       <div class="col-md-11">
          <form action="{{route('empower-update')}}"  method="POST" id="aboutcreate" enctype="multipart/form-data">
             @csrf
             <div class="form-body">
                <div class="card radius shadow-sm">
                   <div class="card-body">
                      <div class="row">
                         <div class="col-md-12">
                            <h4 class="card-title mb-1 mt-3">Edit Empower </h4>
                            <p class="pb-border"> </p>
                         </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="id" value="{{base64_encode($empowers->id)}}">
                                <label for="role" class="form-control-label font-weight-300">Description<span class="text-danger">*</span></label>
                                <textarea class="form-control" placeholder="Enter the Description" id="description" name="description">{{ $empowers->description}}</textarea>
        ...
        $(document).on('click','.add_chose',function(){ 
            ...
            else
            {
                ...
                `<div class='chooseinput' row-id='1'>
                    ...
                    <input class='form-control' type='text' name='coin_description[]' value=''>
                    <p style='margin-bottom: 2px;' class='text-danger error_container error-spoke_name' id="error-spoke_name"></p>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response.success==true) {   
                                toastr.success("Empowering updated Successfully");
                                window.setTimeout(function() {
                                    window.location.href = "{{URL::to('admin/empower-list')}}"
                                }, 2000);
                            }
