...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
       <div class="col-md-11">
          <form action="{{route('card-update')}}"  method="POST" id="cardupdate" enctype="multipart/form-data">
             @csrf
             <div class="form-body">
                <div class="card radius shadow-sm">
                   <div class="card-body">
                      <div class="row">
                         <div class="col-md-12">
                            <h4 class="card-title mb-1 mt-3">Edit Card </h4>
                            <p class="pb-border"> </p>
                         </div>
                      </div>
                      <div class="row">
                         ...
                         <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="id" value="{{base64_encode($card->id)}}">
                               <label for="role" class="form-control-label font-weight-300">Title<span class="text-danger">*</span></label>
                               <input type="text" name="title" value="{{ $card->title }}" class="form-control" placeholder="Title">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" placeholder="Enter the Description" id="description" name="description">{{ $card->description }}</textarea>
...
<script>
        $(document).on('submit', 'form#cardupdate', function (event) {
