...
<div class="col-12">
    <div class="row align-items-center justify-content-center">
       <div class="col-md-11">
          <form action="{{route('card-create')}}"  method="POST" id="cardcreate" enctype="multipart/form-data">
             @csrf
             <div class="form-body">
                <div class="card radius shadow-sm">
                   <div class="card-body">
                      <div class="row">
                         <div class="col-md-12">
                            <h4 class="card-title mb-1 mt-3">Create a New Card </h4>
                            <p class="pb-border"> </p>
                         </div>
                      </div>
                      <div class="row">
...
<script>
    CKEDITOR.replace('description', {
     ...
     <script>
          $(document).on('submit', 'form#cardcreate', function (event) {
